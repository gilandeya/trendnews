...
def screening_guidance(entries: list[dict], limit: int = 12,
    ...
    مدخلات الوسم «لم يُعتمد» (Issue #841 — عدم الاعتماد داخل Issue المراجعة
    يُسجَّل رفضًا تلقائيًا بلا سبب حقيقي) تُستبعد أيضًا: تمريرها هنا يملأ
    توجيه الفرز بعنوان خبر بلا أي سبب يصفه، فيفسد التوجيه بدل أن يحسّنه.
    """
