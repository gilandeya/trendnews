...
_AR_STOP = {"من", "عن", "على", "الى", "إلى", "في", "مع", "بعد", "قبل",
            ...
            # مُوسَّعة (تشخيص Issue #373، الجولة الثانية عشرة): موصولات
            # جمع/مثنى، كان وأخواتها (لا تحمل مضمونًا خبريًا بذاتها)، وأدوات
            # ربط/حروف جر إضافية. verify_draft.check_originality تستعملها
            # لتحديد أي كلمات حدّية في تتابع مرفوض يجوز تقليمها قبل الرفض —
            # لا يمكن لتقليم كلمة وظيفية أن "ينقذ" جملة منسوخة فعليًا، لأن
            # مضمونها يبقى داخل النواة المتبقية. نفس المجموعة (لا قائمة
            # موازية) تُستهلك أصلًا في norm_tokens وevidence._normalize_query_word
            # فتوسيعها هنا يفيد الصلة الرخوة وبناء الاستعلام بالمثل.
            "الذين", "اللاتي", "اللواتي", "اللتان", "اللذان",
            "كان", "كانت", "كانوا", "يكون", "تكون",
            "أصبح", "أصبحت", "ظل", "ظلت", "بات", "باتت", "صار", "صارت",
            "ليس", "ليست", "حتى", "لدى", "دون", "سوى", "أو", "ثم", "كما",
            # ضمائر منفصلة تستأنف جملة معطوفة على اسم علم سبقها («روبرتو
            # كارلوس لاعب ريال مدريد السابق وهو ...») — تشخيص Issue #373،
            # تعليق الموافقة الرابع عشر: لا تحمل مضمونًا خبريًا بذاتها
            # (كـ"كان" وأخواتها أعلاه)، فتُقلَّم بالمثل قبل رفض تتابع نسخ.
            # الصيغة المعطوفة (بواو العطف الملتصقة) مُدرَجة صراحة لأنها
            # كلمة واحدة بعد التوكين (`_WORD_RE`)، لا "و" + "هو" منفصلتين
            "هو", "هي", "هم", "هن", "وهو", "وهي", "وهم", "وهن"}
